 ...
 * <p>
 * <b>Note:</b> this class requires that its containing {@link TwilioPlatform} has been loaded with a valid Github
 * credentials in order to authenticate the bot and access the Github API.
 */
public class ReplyMedia extends RuntimeAction<TwilioPlatform> {
     ...
     */
    public  ReplyMedia(@NonNull TwilioPlatform platform, @NonNull StateContext context,@NonNull String message,@NonNull String media) {

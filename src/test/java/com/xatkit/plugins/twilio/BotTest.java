...
public class BotTest {
    ...
    public static void main(String[] args) {
        ...
        val sendMedia = intent("SendMedia")
        .trainingSentence("send me a picture")
        .trainingSentence("send me a image")
        .trainingSentence("I want an image");
        ...
        awaitingInput
                ...
                .when(intentIs(sendMedia)).moveTo(image);

        handleWelcome
                .body(context -> twilioPlatform.reply(context, "Hi, it's your whatsapp bot here, nice to meet you!"))
                .next()
                /*
        ...
        handleWhatsUp
                .body(context -> twilioPlatform.reply(context, "I am fine and you?"))
                .next()
                .moveTo(awaitingInput);


        image
                .body(context -> twilioPlatform.replyMedia(context, "this is a test image", "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_Homepage.svg/640px-Google_Homepage.svg.png"))
                .next()
                .moveTo(awaitingInput);
        /*
        ...
        val defaultFallback = fallbackState()
                .body(context -> twilioPlatform.reply(context, "Sorry, I didn't, get it"));
       ...
       //dialogFlow
        ...
        // These are the account SID and auth token of the main Twilio account
        botConfiguration.addProperty("xatkit.twilio.username", "twilio.username");
        botConfiguration.addProperty("xatkit.twilio.auth.token", "twilio.authtoken");
